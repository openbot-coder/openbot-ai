...
from openbot.api.server import (
    _FileSizeExceeded,
    _parse_json_content,
    _save_base64_data_url,
    create_app,
)
from openbot.utils.document import extract_documents
...
# ---------------------------------------------------------------------------
# extract_documents tests (now in openbot.utils.document)
# ---------------------------------------------------------------------------
...
def test_extract_documents_skips_extraction_errors(tmp_path, monkeypatch) -> None:
    ...
    import openbot.utils.document as _doc
    monkeypatch.setattr(
        _doc, "extract_text",
