...
from openbot.security.workspace_access import bind_workspace_scope, build_workspace_scope, reset_workspace_scope
...
async def test_exec_blocks_wget_localhost():
    tool = ExecTool()
    with patch("openbot.security.network.socket.getaddrinfo", _fake_resolve_localhost):
...
# --- #2989: block writes to openbot internal state files -----------------
