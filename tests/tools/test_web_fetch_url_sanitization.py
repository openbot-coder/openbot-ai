...
from openbot.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("openbot.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("openbot.agent.tools.web.primp.AsyncClient", FakeClient)
