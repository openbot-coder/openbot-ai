...
from openbot.command import CommandContext
...
def _make_fake_compact(
    ...
    *,
    ...
    from openbot.session.manager import Session as _Session
...
class TestSessionTTLConfig:
    ...
    def test_session_file_cap_is_internal_constant(self):
        ...
        from openbot.session.manager import FILE_MAX_MESSAGES
