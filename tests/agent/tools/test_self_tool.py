...
class TestSubagentStatusFormatting:
    ...
    def test_format_single_status(self):
        ...
        from openbot.agent.subagent import SubagentStatus
...
class TestSubagentHookStatus:
    ...
    async def test_after_iteration_updates_status(self):
        ...
        from openbot.agent.subagent import SubagentStatus, _SubagentHook
    ...
    async def test_after_iteration_no_status_is_noop(self):
        ...
        from openbot.agent.hook import AgentHookContext
        from openbot.agent.subagent import _SubagentHook
...
class TestRuntimeVarsInspectFallback:
    ...
    async def test_inspect_runtime_var_string(self):
        tool = _make_tool()
        await tool.execute(action="set", key="current_project", value="openbot")
