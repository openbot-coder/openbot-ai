...
from openbot.cli import onboard as onboard_wizard
from openbot.cli.commands import _merge_missing_defaults
from openbot.cli.onboard import (
    _BACK_PRESSED,
...
from openbot.utils.helpers import sync_workspace_templates
...
class TestProviderChannelInfo:
    ...
    def test_get_provider_names_returns_dict(self):
        from openbot.cli.onboard import _get_provider_names
    ...
    def test_get_channel_names_returns_dict(self):
        from openbot.cli.onboard import _get_channel_names
    ...
    def test_get_provider_info_returns_valid_structure(self):
        from openbot.cli.onboard import _get_provider_info
...
class TestValidateFieldConstraint:
    ...
    def test_returns_none_when_no_constraints(self):
        ...
        from openbot.cli.onboard import _validate_field_constraint
    ...
    def test_real_send_max_retries_field(self):
        ...
        from openbot.config.schema import ChannelsConfig
        from openbot.cli.onboard import _validate_field_constraint
...
class TestChannelCommonRegistration:
    ...
    def test_channel_common_in_settings_sections(self):
        ...
        from openbot.cli.onboard import _SETTINGS_SECTIONS
    ...
    def test_channel_common_getter_returns_channels(self):
        ...
        from openbot.cli.onboard import _SETTINGS_GETTER
    ...
    def test_channel_common_setter_writes_channels(self):
        ...
        from openbot.cli.onboard import _SETTINGS_SETTER
...
class TestApiServerRegistration:
    ...
    def test_api_server_setter_writes_api(self):
        ...
        config = Config()
        from openbot.config.schema import ApiConfig
...
class TestMainMenuUpdate:
    ...
    def test_main_menu_dispatch_includes_channel_common(self):
        ...
        from openbot.cli.onboard import _SETTINGS_SECTIONS, _SETTINGS_GETTER, _SETTINGS_SETTER
...
class TestIsStrOrNone:
    ...
    def test_str_or_none_true(self):
        from openbot.cli.onboard import _is_str_or_none
...
class TestModelPresetWizard:
    ...
    def test_sync_preset_cache(self):
        ...
        from openbot.cli.onboard import _MODEL_PRESET_CACHE, _sync_preset_cache
    ...
    def test_model_preset_add(self, monkeypatch):
        ...
        from openbot.cli.onboard import _MODEL_PRESET_CACHE, _configure_model_presets
        from openbot.config.schema import ModelPresetConfig
    ...
    def test_model_preset_field_handler(self, monkeypatch):
        ...
        from openbot.cli.onboard import _MODEL_PRESET_CACHE, _handle_model_preset_field
        from openbot.config.schema import AgentDefaults
    ...
    def test_main_menu_dispatch_includes_model_presets(self):
        ...
        from openbot.cli.onboard import _configure_model_presets
    ...
    def test_fallback_models_field_add(self, monkeypatch):
        ...
        from openbot.cli.onboard import _MODEL_PRESET_CACHE, _handle_fallback_models_field
        from openbot.config.schema import AgentDefaults
    ...
    def test_provider_field_handler(self, monkeypatch):
        ...
        from openbot.cli.onboard import _handle_provider_field
        from openbot.config.schema import AgentDefaults
