...
from openbot.agent.loop import AgentLoop, TurnContext, TurnState
...
from openbot.utils.document import reference_non_image_attachments
...
async def test_state_restore_extracts_documents_by_default(
    ...
    monkeypatch.setattr("openbot.agent.loop.extract_documents", fake_extract_documents)
...
async def test_state_restore_references_documents_when_extraction_disabled(
    ...
    monkeypatch.setattr("openbot.agent.loop.extract_documents", fail_extract_documents)
