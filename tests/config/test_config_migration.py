...
def test_onboard_does_not_crash_with_legacy_memory_window(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("openbot.config.loader.get_config_path", lambda: config_path)
    monkeypatch.setattr("openbot.cli.commands.get_workspace_path", lambda _workspace=None: workspace)
