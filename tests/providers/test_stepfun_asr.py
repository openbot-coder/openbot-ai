...
from openbot.providers.transcription import StepFunTranscriptionProvider
...
def test_stepfun_in_registry() -> None:
    ...
    assert spec.adapter == "openbot.providers.transcription:StepFunTranscriptionProvider"
