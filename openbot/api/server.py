"""OpenAI-compatible HTTP API server for a fixed openbot session.
...
from openbot.utils.helpers import safe_filename
...
from openbot.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
...
async def handle_chat_completions(request: web.Request) -> web.Response:
    ...
    model_name: str = request.app.get("model_name", "openbot")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "openbot")
    return web.json_response(
        {
            "object": "list",
            "data": [
...
def create_app(
    agent_loop, model_name: str = "openbot", request_timeout: float = 120.0
) -> web.Application:
