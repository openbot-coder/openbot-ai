...
from openbot.audio.transcription import resolve_transcription_config
from openbot.audio.transcription_registry import (
    resolve_transcription_provider,
    transcription_provider_names,
)
from openbot.config.loader import get_config_path, load_config, save_config
...
from openbot.security.workspace_access import workspace_sandbox_status
from openbot.webui.token_usage import token_usage_payload
from openbot.webui.workspaces import (
...
def _oauth_provider_status(spec: Any) -> dict[str, Any]:
    ...
    if spec.name == "github_copilot":
        try:
            from openbot.providers.github_copilot_provider import get_github_copilot_login_status
        except Exception:
            return {
                "configured": False,
                "account": None,
...
def login_oauth_provider(query: QueryParams) -> dict[str, Any]:
    ...
    if spec.name == "github_copilot":
        try:
            from openbot.providers.github_copilot_provider import (
