...
from openbot.agent.tools.mcp import request_mcp_reload
from openbot.bus.queue import MessageBus
from openbot.webui.cli_apps_api import cli_apps_action, cli_apps_payload
from openbot.webui.mcp_presets_api import mcp_presets_settings_action
...
from openbot.webui.version_check import check_for_update

QueryParams = dict[str, list[str]]

_MCP_VALUES_HEADER = "X-openbot-MCP-Values"
