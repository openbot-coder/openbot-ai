...
from openbot.cron.types import CronSchedule

if TYPE_CHECKING:
    from openbot.agent.tools.cli_apps import CliAppsToolConfig
    from openbot.agent.tools.image_generation import ImageGenerationToolConfig
    from openbot.agent.tools.self import MyToolConfig
    from openbot.agent.tools.shell import ExecToolConfig
    from openbot.agent.tools.web import WebToolsConfig
...
class TranscriptionConfig(Base):
    ...
    enabled: bool = True
    provider: str | None = None  # Validated by openbot.audio.transcription_registry.
    model: str | None = None
...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from openbot.providers.base import GenerationSettings
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.openbot/workspace"
    ...
    bot_name: str = "openbot"  # Display name shown in CLI prompts (e.g. "{name} is thinking...")
...
class ToolsConfig(Base):
    ...
    web: WebToolsConfig = Field(default_factory=lambda: _lazy_default("openbot.agent.tools.web", "WebToolsConfig"))
    exec: ExecToolConfig = Field(default_factory=lambda: _lazy_default("openbot.agent.tools.shell", "ExecToolConfig"))
    cli_apps: CliAppsToolConfig = Field(default_factory=lambda: _lazy_default("openbot.agent.tools.cli_apps", "CliAppsToolConfig"))
    my: MyToolConfig = Field(default_factory=lambda: _lazy_default("openbot.agent.tools.self", "MyToolConfig"))
    image_generation: ImageGenerationToolConfig = Field(
        default_factory=lambda: _lazy_default("openbot.agent.tools.image_generation", "ImageGenerationToolConfig"),
    )
...
class Config(BaseSettings):
    ...
    def _match_provider(
        ...
        *,
        ...
        from openbot.providers.registry import PROVIDERS, find_by_name
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from openbot.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
    ...
    from openbot.agent.tools.self import MyToolConfig
    from openbot.agent.tools.shell import ExecToolConfig
    from openbot.agent.tools.web import WebFetchConfig, WebSearchConfig, WebToolsConfig
