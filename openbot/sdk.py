"""High-level programmatic interface to openbot."""
...
from openbot.agent.hook import AgentHook, SDKCaptureHook
...
class openbot:
    """Programmatic facade for running the openbot agent.
    ...
    async def __aenter__(self) -> openbot:
        return self
