...
Persistent storage at ``~/.openbot/pairing.json`` keeps approved senders
...
from openbot.config.paths import get_data_dir
from openbot.utils.helpers import _write_text_atomic
