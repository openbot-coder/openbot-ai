...
from openbot.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "openbot.webui.thread_disk",
    "webui_transcript": "openbot.webui.transcript",
    "webui_turn_helpers": "openbot.session.webui_turns",
}
