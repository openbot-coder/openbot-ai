...
This module owns openbot's transcription behavior: config resolution,
...
HTTP details; those live in ``openbot.providers.transcription``.
"""
...
from openbot.utils.media_decode import FileSizeExceeded, save_base64_data_url
