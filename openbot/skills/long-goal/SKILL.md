...
`long_task` is a lightweight marker. Calling it tells openbot: "this thread has a sustained objective; keep that objective visible across turns and surface it in the UI."
