...
This directory contains built-in skills that extend openbot's capabilities.
...
When skills reference large local documentation or logs, prefer openbot's built-in
