...
from openbot.agent.hook import AgentHook, AgentHookContext, AgentRunHookContext
...
from openbot.utils.file_edit_events import (
...
from openbot.utils.progress_events import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set openbot_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("openbot_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (openbot_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded openbot_LLM_TIMEOUT_S.
