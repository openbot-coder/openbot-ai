...
class SkillsLoader:
    ...
    def _parse_openbot_metadata(self, raw: object) -> dict:
        """Extract openbot/openclaw metadata from a frontmatter field.
        ...
        if not isinstance(data, dict):
            return {}
        payload = data.get("openbot", data.get("openclaw", {}))
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get openbot metadata for a skill (cached in frontmatter)."""
        raw_meta = self.get_skill_metadata(name) or {}
        return self._parse_openbot_metadata(raw_meta.get("metadata"))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        return [
            ...
            and (
                self._parse_openbot_metadata(meta.get("metadata")).get("always")
                or meta.get("always")
            )
        ]
