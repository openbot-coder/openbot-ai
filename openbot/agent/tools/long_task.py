...
``openbot.session.goal_state.goal_state_runtime_lines``) so compaction cannot hide them.
...
from openbot.agent.tools.schema import StringSchema, tool_parameters_schema
from openbot.bus.runtime_events import GoalStateChanged, RuntimeEventBus, RuntimeEventContext
