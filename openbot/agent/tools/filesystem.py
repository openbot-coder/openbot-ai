...
from openbot.agent.tools.file_state import FileStates, _hash_file, current_file_states
from openbot.agent.tools.path_utils import resolve_workspace_path
from openbot.security.workspace_access import current_tool_workspace
...
from openbot.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from openbot.utils.document import extract_text
