...
from openbot.agent.tools.context import ContextAware, RequestContext
from openbot.agent.tools.path_utils import resolve_workspace_path
from openbot.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from openbot.security.workspace_access import current_tool_workspace
from openbot.bus.events import OutboundMessage
from openbot.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from openbot.utils.helpers import strip_think
