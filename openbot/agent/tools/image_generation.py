...
from openbot.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path
...
if TYPE_CHECKING:
    from openbot.config.schema import ProviderConfig
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        try:
            ...
            raise ImageGenerationError(
                "reference_images must be inside the workspace or openbot media directory"
            ) from exc
