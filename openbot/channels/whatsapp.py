...
def _ensure_bridge_setup() -> Path:
    ...
    """
    from openbot.config.paths import get_bridge_install_dir

    user_bridge = get_bridge_install_dir()
    stamp_file = user_bridge / ".openbot-bridge-source-hash"
    ...
    if not source:
        raise RuntimeError(
            ...
            "Try reinstalling: pip install --force-reinstall openbot"
        )
