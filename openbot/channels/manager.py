...
from openbot.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import openbot.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        from openbot.channels.registry import discover_channel_names, discover_enabled
        ...
        for name, cls in discover_enabled(enabled_names, _names=names).items():
            ...
            try:
                ...
                if cls.name == "websocket":
                    from openbot.channels.websocket import WebSocketConfig
