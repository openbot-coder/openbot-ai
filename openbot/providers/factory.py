...
from openbot.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "openai_codex":
        ...
        from openbot.providers.azure_openai_provider import AzureOpenAIProvider
