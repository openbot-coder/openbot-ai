...
import { useopenbotStream, type SendImage, type SendOptions } from "@/hooks/useopenbotStream";
...
export function ThreadShell({
  ...
  const {
    ...
    streamError,
    dismissStreamError,
  } = useopenbotStream(chatId, initial, hasPendingToolCalls, handleTurnEnd);
  ...
  // Persist thread to in-memory cache after paint so ``useopenbotStream``'s chat switch
